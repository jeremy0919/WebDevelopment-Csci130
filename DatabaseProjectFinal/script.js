...
function edit1() {
        if (document.getElementById("InsPokemon").readOnly == false) {
        document.getElementById("InsPokemon").readOnly = true;
        document.getElementById("InsEvolution").readOnly = true;
        document.getElementById("insShinyColor").readOnly = true;
        document.getElementById("InsAverageSize").readOnly = true;
        document.getElementById("InsType").readOnly = true;
        document.getElementById("InsWeakTo").readOnly = true;
        document.getElementById("InsCanEvolve").readOnly = true;
        document.getElementById("fileup").readOnly = true;
            } 
            else {
        document.getElementById("InsPokemon").readOnly = false;
        document.getElementById("InsEvolution").readOnly = false;
        document.getElementById("insShinyColor").readOnly = false;
        document.getElementById("InsAverageSize").readOnly = false;
        document.getElementById("InsType").readOnly = false;
        document.getElementById("InsWeakTo").readOnly = false;
        document.getElementById("InsCanEvolve").readOnly = false;
        document.getElementById("fileup").readOnly = false;
            }
